...
const createMenuItemSchema = Joi.object({
  ...
  discounted_price:      Joi.number().positive().precision(2).less(Joi.ref('price')).optional().allow(null),
  image_url:             Joi.string().uri().max(500).optional().allow('', null),
  is_veg:                Joi.boolean().default(true),
  preparation_time_mins: Joi.number().integer().min(1).max(180).default(15),
